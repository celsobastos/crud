...
<body id="page-top">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
                            href="#portfolio">List Customers</a></li>
                    
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
                            href="#contact">Add New Customer</a></li>
                </ul>
            </div>
        </div>
    </nav>
        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    ?>
                    <tr>
                        <th scope="row"><?=$row['id_customers']?></th>
                        <td><?=$row['name']?></td>
                        <td><?=$row['email']?></td>
                        <td><?=$row['phone']?></td>
    ...
    <section class="page-section" id="contact">
        <div class="container">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">New Customers</h2>
            <!-- Icon Divider-->
                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <form action="insert.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="btn btn-primary btn-xl" type="submit" name="send" value="Send" />
